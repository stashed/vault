...
func generateSwaggerJson() {
	...
	apispec, err := openapi.RenderOpenAPISpec(openapi.Config{
		...
		Resources: []openapi.TypeInfo{
			{api.SchemeGroupVersion, api.ResourceStashMySQLs, api.ResourceKindStashMySQL, false},
		},
	})
	if err != nil {
		glog.Fatal(err)
	...
	filename := gort.GOPath() + "/src/stash.appscode.dev/mysql/api/openapi-spec/swagger.json"
