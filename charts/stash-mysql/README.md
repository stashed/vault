...
$ helm repo update
$ helm install stash-mysql-v2020.08.26-rc.1 appscode/stash-mysql -n kube-system --version=v2020.08.26-rc.1
```
...
To install the chart with the release name `stash-mysql-v2020.08.26-rc.1`:
...
To uninstall/delete the `stash-mysql-v2020.08.26-rc.1`:

```console
$ helm delete stash-mysql-v2020.08.26-rc.1 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore MySQL database. This is usually same as the database version it can backup. | `v2020.08.26-rc.1`  |
...
```console
$ helm install stash-mysql-v2020.08.26-rc.1 appscode/stash-mysql -n kube-system --version=v2020.08.26-rc.1 --set image.registry=stashed
```
...
```console
$ helm install stash-mysql-v2020.08.26-rc.1 appscode/stash-mysql -n kube-system --version=v2020.08.26-rc.1 --values values.yaml
```
