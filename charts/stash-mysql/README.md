...
$ helm repo update
$ helm install stash-mysql-v2020.07.08-beta.0 appscode/stash-mysql -n kube-system --version=v2020.07.08-beta.0
```
...
To install the chart with the release name `stash-mysql-v2020.07.08-beta.0`:
...
To uninstall/delete the `stash-mysql-v2020.07.08-beta.0`:

```console
$ helm delete stash-mysql-v2020.07.08-beta.0 -n kube-system
```
...
```console
$ helm install stash-mysql-v2020.07.08-beta.0 appscode/stash-mysql -n kube-system --version=v2020.07.08-beta.0 --set image.registry=stashed
```
...
```console
$ helm install stash-mysql-v2020.07.08-beta.0 appscode/stash-mysql -n kube-system --version=v2020.07.08-beta.0 --values values.yaml
```
