...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.ImageRef":       schema_mysql_apis_installer_v1alpha1_ImageRef(ref),
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.MySQLBackup":    schema_mysql_apis_installer_v1alpha1_MySQLBackup(ref),
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.MySQLRestore":   schema_mysql_apis_installer_v1alpha1_MySQLRestore(ref),
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQL":     schema_mysql_apis_installer_v1alpha1_StashMySQL(ref),
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQLList": schema_mysql_apis_installer_v1alpha1_StashMySQLList(ref),
		"stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQLSpec": schema_mysql_apis_installer_v1alpha1_StashMySQLSpec(ref),
	}
}
...
func schema_mysql_apis_installer_v1alpha1_ImageRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_mysql_apis_installer_v1alpha1_MySQLBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_mysql_apis_installer_v1alpha1_MySQLRestore(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_mysql_apis_installer_v1alpha1_StashMySQL(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQLSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQLSpec"},
	}
}

func schema_mysql_apis_installer_v1alpha1_StashMySQLList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StashMySQLList is a list of StashMySQLs",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of StashMySQL CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQL"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "stash.appscode.dev/mysql/apis/installer/v1alpha1.StashMySQL"},
	}
}

func schema_mysql_apis_installer_v1alpha1_StashMySQLSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"image": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/mysql/apis/installer/v1alpha1.ImageRef"),
						},
					},
					"backup": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/mysql/apis/installer/v1alpha1.MySQLBackup"),
						},
					},
					"restore": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"stash.appscode.dev/mysql/apis/installer/v1alpha1.ImageRef", "stash.appscode.dev/mysql/apis/installer/v1alpha1.MySQLBackup", "stash.appscode.dev/mysql/apis/installer/v1alpha1.MySQLRestore"},
	}
}
